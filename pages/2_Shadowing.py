...
if st.session_state.shadowing_script:
    ...
    speed_options = list(speed_mapping.keys())
    
    # セッションステートの値がoptionsにない場合の安全対策
    current_index = speed_options.index(st.session_state.sh_audio_speed) if st.session_state.sh_audio_speed in speed_options else 5
